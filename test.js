...
let inputElement;
let outputElement;
let storyPreface = "Create a 3 paragraph children's story book based on the following prompt: "
...
async function generatePictureBook() {
  ...
  if (promptText === "") {
    ...
    setResponse("Waiting...");
    let responseText = sampleText;
    //let responseText = await generateResponse(promptText, storyPreface);
    setResponse(responseText);

    let paragraphList = getParagraphs(responseText);
    ...
    for (let imgPrompt of imgPromptList) {
        let curPrompt = await generateImage(imgPrompt, dallEPreface);
        imgList.push(curPrompt);
        console.log(imgList);
    }
  ...
  <body>
    <div>
      ...
      <div class="home-container">
        <div class="home-container1"><h1 id="title">Title</h1></div>
        <div class="home-container2">
          ...
          <div class="home-container4"><span>Text</span></div>
        </div>
        <div class="home-container5">
          <button class="button">Prev</button>
          <span class="home-text2">1</span>
